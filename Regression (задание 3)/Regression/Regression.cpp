...
// Regression.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CRegressionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CRegressionApp

CRegressionApp::CRegressionApp()
{
...
// Единственный объект CRegressionApp

CRegressionApp theApp;


// Инициализация CRegressionApp

BOOL CRegressionApp::InitInstance()
{
